...
class CombatLogCleanupTaskTest extends McRPGBaseTest {
    ...
    void setUp() throws Exception {
        ...
        // Must be short of CombatLogDAO's delete batch size: a full batch tells the retention sweep
        // there may be more rows, so a constant full-batch stub would never let it terminate.
