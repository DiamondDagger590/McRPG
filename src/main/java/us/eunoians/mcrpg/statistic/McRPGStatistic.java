...
public final class McRPGStatistic {
    ...
    // Guardian ability statistics
    /** Total bonus crit damage dealt via Phase Shift. */
    public static final Statistic PHASE_SHIFT_CRIT_DAMAGE_DEALT = new SimpleStatistic(
            key("phase_shift_crit_damage_dealt"), StatisticType.DOUBLE, 0.0,
            "Phase Shift Crit Damage", "Total bonus crit damage dealt via Phase Shift");

    /** Total blocks teleported via Phase Shift. */
    public static final Statistic PHASE_SHIFT_DISTANCE_TELEPORTED = new SimpleStatistic(
            key("phase_shift_distance_teleported"), StatisticType.DOUBLE, 0.0,
            "Phase Shift Distance", "Total blocks teleported via Phase Shift");

    /** Total meters entities were pulled toward Whirlpool center. */
    public static final Statistic WHIRLPOOL_TOTAL_PULL_DISTANCE = new SimpleStatistic(
            key("whirlpool_total_pull_distance"), StatisticType.DOUBLE, 0.0,
            "Whirlpool Pull Distance", "Total meters entities were pulled toward center");

    /** Total unique entities affected by Whirlpool. */
    public static final Statistic WHIRLPOOL_ENTITIES_AFFECTED = longStat("whirlpool_entities_affected",
            "Whirlpool Entities Affected", "Total unique entities affected by Whirlpool");

    /** Total successful Waterlogged Strike projectile hits. */
    public static final Statistic WATERLOGGED_STRIKE_HITS = longStat("waterlogged_strike_hits",
            "Waterlogged Strike Hits", "Total successful projectile hits");

    /** Total damage dealt by Waterlogged Strike impacts. */
    public static final Statistic WATERLOGGED_STRIKE_DAMAGE_DEALT = new SimpleStatistic(
            key("waterlogged_strike_damage_dealt"), StatisticType.DOUBLE, 0.0,
            "Waterlogged Strike Damage", "Total damage dealt by Waterlogged Strike impacts");

    /** Total entities knocked back by Tsunami Wall. */
    public static final Statistic TSUNAMI_WALL_ENTITIES_KNOCKED = longStat("tsunami_wall_entities_knocked",
            "Tsunami Wall Entities Knocked", "Total entities knocked back by Tsunami Wall");

    /** Total knockback force applied across all Tsunami Wall contacts. */
    public static final Statistic TSUNAMI_WALL_TOTAL_KNOCKBACK_APPLIED = new SimpleStatistic(
            key("tsunami_wall_total_knockback_applied"), StatisticType.DOUBLE, 0.0,
            "Tsunami Wall Knockback Applied", "Total knockback force applied across all contacts");
    ...
    static {
        ...
        // Guardian ability statistics
        stats.add(PHASE_SHIFT_CRIT_DAMAGE_DEALT);
        stats.add(PHASE_SHIFT_DISTANCE_TELEPORTED);
        stats.add(WHIRLPOOL_TOTAL_PULL_DISTANCE);
        stats.add(WHIRLPOOL_ENTITIES_AFFECTED);
        stats.add(WATERLOGGED_STRIKE_HITS);
        stats.add(WATERLOGGED_STRIKE_DAMAGE_DEALT);
        stats.add(TSUNAMI_WALL_ENTITIES_KNOCKED);
        stats.add(TSUNAMI_WALL_TOTAL_KNOCKBACK_APPLIED);
