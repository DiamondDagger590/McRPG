...
public final class LocalizationKey extends ConfigFile {
    ...
    private static final String QUEST_OBJECTIVE_CRAFT_ITEM_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "craft-item");
    public static final Route QUEST_OBJECTIVE_CRAFT_ITEM_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CRAFT_ITEM_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_CRAFT_ITEM_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CRAFT_ITEM_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_CRAFT_ITEM_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CRAFT_ITEM_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_CRAFT_ITEM_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CRAFT_ITEM_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_SMELT_ITEM_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "smelt-item");
    public static final Route QUEST_OBJECTIVE_SMELT_ITEM_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMELT_ITEM_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_SMELT_ITEM_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMELT_ITEM_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_SMELT_ITEM_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMELT_ITEM_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_SMELT_ITEM_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMELT_ITEM_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_FISH_CATCH_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "fish-catch");
    public static final Route QUEST_OBJECTIVE_FISH_CATCH_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FISH_CATCH_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_FISH_CATCH_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FISH_CATCH_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_FISH_CATCH_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FISH_CATCH_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_FISH_CATCH_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FISH_CATCH_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_ITEM_PICKUP_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "item-pickup");
    public static final Route QUEST_OBJECTIVE_ITEM_PICKUP_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ITEM_PICKUP_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_ITEM_PICKUP_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ITEM_PICKUP_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_ITEM_PICKUP_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ITEM_PICKUP_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_ITEM_PICKUP_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ITEM_PICKUP_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_SMITHING_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "smithing");
    public static final Route QUEST_OBJECTIVE_SMITHING_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMITHING_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_SMITHING_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMITHING_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_SMITHING_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMITHING_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_SMITHING_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SMITHING_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_ANVIL_REPAIR_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "anvil-repair");
    public static final Route QUEST_OBJECTIVE_ANVIL_REPAIR_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ANVIL_REPAIR_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_ANVIL_REPAIR_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ANVIL_REPAIR_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_ANVIL_REPAIR_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ANVIL_REPAIR_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_ANVIL_REPAIR_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ANVIL_REPAIR_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "enchant-item");
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_SINGLE_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "single-item"));
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_SINGLE_ENCHANTMENT = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "single-enchantment"));
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_SINGLE_BOTH = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "single-both"));
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "multi-item"));
    public static final Route QUEST_OBJECTIVE_ENCHANT_ITEM_MULTI_ENCHANTMENT = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ENCHANT_ITEM_HEADER, "multi-enchantment"));
    private static final String QUEST_OBJECTIVE_BLOCK_PLACE_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "block-place");
    public static final Route QUEST_OBJECTIVE_BLOCK_PLACE_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BLOCK_PLACE_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_BLOCK_PLACE_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BLOCK_PLACE_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_BLOCK_PLACE_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BLOCK_PLACE_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_BLOCK_PLACE_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BLOCK_PLACE_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_CONSUME_ITEM_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "consume-item");
    public static final Route QUEST_OBJECTIVE_CONSUME_ITEM_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CONSUME_ITEM_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_CONSUME_ITEM_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CONSUME_ITEM_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_CONSUME_ITEM_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CONSUME_ITEM_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_CONSUME_ITEM_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_CONSUME_ITEM_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_HARVEST_CROP_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "harvest-crop");
    public static final Route QUEST_OBJECTIVE_HARVEST_CROP_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_HARVEST_CROP_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_HARVEST_CROP_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_HARVEST_CROP_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_HARVEST_CROP_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_HARVEST_CROP_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_HARVEST_CROP_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_HARVEST_CROP_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_FERTILIZE_BLOCK_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "fertilize-block");
    public static final Route QUEST_OBJECTIVE_FERTILIZE_BLOCK_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FERTILIZE_BLOCK_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_FERTILIZE_BLOCK_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FERTILIZE_BLOCK_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_FERTILIZE_BLOCK_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FERTILIZE_BLOCK_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_FERTILIZE_BLOCK_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_FERTILIZE_BLOCK_HEADER, "multi-item"));
    public static final Route QUEST_OBJECTIVE_GAIN_EXPERIENCE_DESCRIPTION = Route.fromString(toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "gain-experience.description"));
    public static final Route QUEST_OBJECTIVE_ENTER_BED_DESCRIPTION = Route.fromString(toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "enter-bed.description"));
    private static final String QUEST_OBJECTIVE_BREED_ANIMAL_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "breed-animal");
    public static final Route QUEST_OBJECTIVE_BREED_ANIMAL_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BREED_ANIMAL_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_BREED_ANIMAL_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BREED_ANIMAL_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_BREED_ANIMAL_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BREED_ANIMAL_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_BREED_ANIMAL_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BREED_ANIMAL_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_TAME_ANIMAL_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "tame-animal");
    public static final Route QUEST_OBJECTIVE_TAME_ANIMAL_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_TAME_ANIMAL_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_TAME_ANIMAL_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_TAME_ANIMAL_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_TAME_ANIMAL_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_TAME_ANIMAL_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_TAME_ANIMAL_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_TAME_ANIMAL_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_SHEAR_ENTITY_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "shear-entity");
    public static final Route QUEST_OBJECTIVE_SHEAR_ENTITY_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SHEAR_ENTITY_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_SHEAR_ENTITY_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SHEAR_ENTITY_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_SHEAR_ENTITY_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SHEAR_ENTITY_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_SHEAR_ENTITY_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_SHEAR_ENTITY_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_VILLAGER_TRADE_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "villager-trade");
    public static final Route QUEST_OBJECTIVE_VILLAGER_TRADE_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_VILLAGER_TRADE_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_VILLAGER_TRADE_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_VILLAGER_TRADE_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_VILLAGER_TRADE_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_VILLAGER_TRADE_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_VILLAGER_TRADE_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_VILLAGER_TRADE_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_BUCKET_FILL_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "bucket-fill");
    public static final Route QUEST_OBJECTIVE_BUCKET_FILL_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_FILL_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_BUCKET_FILL_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_FILL_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_BUCKET_FILL_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_FILL_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_BUCKET_FILL_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_FILL_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_BUCKET_EMPTY_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "bucket-empty");
    public static final Route QUEST_OBJECTIVE_BUCKET_EMPTY_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_EMPTY_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_BUCKET_EMPTY_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_EMPTY_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_BUCKET_EMPTY_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_EMPTY_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_BUCKET_EMPTY_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_BUCKET_EMPTY_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_DEAL_DAMAGE_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "deal-damage");
    public static final Route QUEST_OBJECTIVE_DEAL_DAMAGE_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DEAL_DAMAGE_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_DEAL_DAMAGE_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DEAL_DAMAGE_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_DEAL_DAMAGE_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DEAL_DAMAGE_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_DEAL_DAMAGE_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DEAL_DAMAGE_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_DAMAGE_TAKEN_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "damage-taken");
    public static final Route QUEST_OBJECTIVE_DAMAGE_TAKEN_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DAMAGE_TAKEN_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_DAMAGE_TAKEN_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DAMAGE_TAKEN_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_DAMAGE_TAKEN_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DAMAGE_TAKEN_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_DAMAGE_TAKEN_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DAMAGE_TAKEN_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_PROJECTILE_HIT_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "projectile-hit");
    public static final Route QUEST_OBJECTIVE_PROJECTILE_HIT_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_PROJECTILE_HIT_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_PROJECTILE_HIT_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_PROJECTILE_HIT_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_PROJECTILE_HIT_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_PROJECTILE_HIT_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_PROJECTILE_HIT_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_PROJECTILE_HIT_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_LAUNCH_PROJECTILE_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "launch-projectile");
    public static final Route QUEST_OBJECTIVE_LAUNCH_PROJECTILE_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_LAUNCH_PROJECTILE_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_LAUNCH_PROJECTILE_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_LAUNCH_PROJECTILE_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_LAUNCH_PROJECTILE_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_LAUNCH_PROJECTILE_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_LAUNCH_PROJECTILE_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_LAUNCH_PROJECTILE_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "advancement-complete");
    public static final Route QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_ADVANCEMENT_COMPLETE_HEADER, "multi-item"));
    private static final String QUEST_OBJECTIVE_DISTANCE_TRAVELED_HEADER = toRoutePath(QUEST_OBJECTIVE_TYPE_HEADER, "distance-traveled");
    public static final Route QUEST_OBJECTIVE_DISTANCE_TRAVELED_ANY = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DISTANCE_TRAVELED_HEADER, "any"));
    public static final Route QUEST_OBJECTIVE_DISTANCE_TRAVELED_SINGLE = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DISTANCE_TRAVELED_HEADER, "single"));
    public static final Route QUEST_OBJECTIVE_DISTANCE_TRAVELED_MULTI_HEADER = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DISTANCE_TRAVELED_HEADER, "multi-header"));
    public static final Route QUEST_OBJECTIVE_DISTANCE_TRAVELED_MULTI_ITEM = Route.fromString(toRoutePath(QUEST_OBJECTIVE_DISTANCE_TRAVELED_HEADER, "multi-item"));
