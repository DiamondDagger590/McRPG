...
public class RestedExperienceSlot implements McRPGSlot {
    ...
    public ItemBuilder getItem(@NotNull McRPGPlayer mcRPGPlayer) {
        ...
        ItemBuilder itemBuilder = ItemBuilder.from(localizationManager.getLocalizedSection(mcRPGPlayer, LocalizationKey.EXPERIENCE_BANK_GUI_RESTED_EXPERIENCE_SLOT_DISPLAY_ITEM))
