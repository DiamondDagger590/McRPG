...
public class RedeemLevelsCustomSlot implements McRPGSlot {
    ...
    public ItemBuilder getItem(@NotNull McRPGPlayer mcRPGPlayer) {
        ...
        ItemBuilder itemBuilder = ItemBuilder.from(localizationManager.getLocalizedSection(mcRPGPlayer, LocalizationKey.REDEEMABLE_LEVELS_GUI_REDEEM_CUSTOM_BUTTON_DISPLAY_ITEM))
