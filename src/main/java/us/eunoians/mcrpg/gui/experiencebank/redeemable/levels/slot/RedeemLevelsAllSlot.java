...
/**
 * This slot allows a player to redeem all of their redeemable levels
 * into a given {@link Skill}.
 */
public class RedeemLevelsAllSlot implements McRPGSlot {

    private final Skill skill;

    public RedeemLevelsAllSlot(@NotNull Skill skill) {
        this.skill = skill;
    }
    ...
    public ItemBuilder getItem(@NotNull McRPGPlayer mcRPGPlayer) {
        ...
        ItemBuilder itemBuilder = ItemBuilder.from(localizationManager.getLocalizedSection(mcRPGPlayer, LocalizationKey.REDEEMABLE_LEVELS_GUI_REDEEM_ALL_BUTTON_DISPLAY_ITEM))
    ...
    public boolean onClick(@NotNull McRPGPlayer mcRPGPlayer, @NotNull ClickType clickType) {
        mcRPGPlayer.getAsBukkitPlayer().ifPresent(player -> {
            ...
            player.performCommand("mcrpg redeem levels " + skill.getName(mcRPGPlayer)+ " all");
