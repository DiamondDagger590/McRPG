...
public class LoadoutDisplayNameEditSlot implements McRPGSlot {
    ...
    public ItemBuilder getItem(@NotNull McRPGPlayer mcRPGPlayer) {
        ...
        ItemBuilder itemBuilder = ItemBuilder.from(localizationManager.getLocalizedSection(mcRPGPlayer, LocalizationKey.LOADOUT_DISPLAY_HOME_GUI_NAME_EDIT_DISPLAY_ITEM));
