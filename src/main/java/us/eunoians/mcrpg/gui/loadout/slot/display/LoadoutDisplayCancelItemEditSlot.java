...
public class LoadoutDisplayCancelItemEditSlot implements McRPGSlot {
    ...
    public ItemBuilder getItem(@NotNull McRPGPlayer mcRPGPlayer) {
        ...
        ItemBuilder itemBuilder = ItemBuilder.from(localizationManager.getLocalizedSection(mcRPGPlayer, LocalizationKey.LOADOUT_DISPLAY_ITEM_INPUT_GUI_CANCEL_ITEM_EDIT_DISPLAY_ITEM));
