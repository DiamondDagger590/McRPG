...
/**
 * Info slot placed at the center of {@link QuestChainHistoryDetailGui} when the chain run
 * has no completed step records to display. Shows a localized "no steps yet" message.
 */
public class ChainHistoryEmptySlot implements McRPGSlot {
    ...
    public ItemBuilder getItem(@NotNull McRPGPlayer mcRPGPlayer) {
        ...
        String emptyMessage = localizationManager.getLocalizedMessage(
                mcRPGPlayer, LocalizationKey.QUEST_CHAIN_HISTORY_GUI_EMPTY_STATE);
