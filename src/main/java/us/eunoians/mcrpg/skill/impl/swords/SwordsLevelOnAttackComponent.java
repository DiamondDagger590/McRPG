 ...
 */
class SwordsLevelOnAttackComponent implements OnAttackLevelableComponent {

    private final Map<EntityType, Route> ENTITY_TYPE_EXPERIENCE_ROUTE_MAP = new HashMap<>();
