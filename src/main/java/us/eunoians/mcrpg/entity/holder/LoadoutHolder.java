 ...
 * abilities unlocked.
 * <p>
 * A loadout can only hold {@link us.eunoians.mcrpg.ability.UnlockableAbility UnlockableAbilities},
...
public class LoadoutHolder extends AbilityHolder {
    ...
    /**
     * Gets a {@link Set} of all {@link NamespacedKey}s that represent {@link us.eunoians.mcrpg.ability.Ability Abilities}
     * that are in the holder's loadout.
     *
     * @return A {@link Set} of all {@link NamespacedKey}s that represent {@link us.eunoians.mcrpg.ability.Ability Abilities}
     * that are in the holder's loadout.
     */
    ...
    /**
     * Gets a {@link Set} of all the {@link NamespacedKey}s that represent {@link us.eunoians.mcrpg.ability.Ability Abilities}
     ...
     *
     * @return A {@link Set} of all the {@link NamespacedKey}s that represent {@link us.eunoians.mcrpg.ability.Ability Abilities}
     * that this holder can activate.
     */
