...
public enum SoundEnum implements ConfigurationEnum{
  ...
  MISC_ABILITY_POINT_GAIN_VOLUME("Sounds.Misc.AbilityPointGain.Volume", 2),
  ...
  MISC_LEVEL_UP_VOLUME("Sounds.Misc.LevelUp.Volume", 2),
  ...
  MISC_ABILITY_UNLOCKED_VOLUME("Sounds.Misc.AbilityUnlocked.Volume", 3),
  ...
  MISC_REPLACE_COOLDOWN_PENDING_VOLUME("Sounds.Misc.ReplaceCooldownPending.Volume", 5),
  ...
  MISC_UPGRADE_ABILITY_VOLUME("Sounds.Misc.UpgradeAbility.Volume", 5),
  ...
  MISC_CANT_UPGRADE_ABILITY_VOLUME("Sounds.Misc.CantUpgradeAbility.Volume", 5),
  ...
  MISC_DENY_REPLACE_VOLUME("Sounds.Misc.DenyReplace.Volume", 5),
  ...
  MINING_BLAST_MINING_VOLUME("Sounds.Mining.BlastMining.Volume", 5),
  ...
  MINING_SUPER_BREAKER_VOLUME("Sounds.Mining.SuperBreaker.Volume", 5),
  ...
  UNARMED_STICKY_FINGERS_VOLUME("Sounds.Unarmed.StickyFingers.Volume", 5),
  ...
  UNARMED_SMITING_FIST_VOLUME("Sounds.Unarmed.SmitingFist.Volume", 5),
  ...
  UNARMED_SMITING_FIST_ENDED_VOLUME("Sounds.Unarmed.SmitingFistEnded.Volume", 5),
  ...
  UNARMED_BERSERK_VOLUME("Sounds.Unarmed.Berserk.Volume", 5),
  ...
  UNARMED_BERSERK_ENDED_VOLUME("Sounds.Unarmed.BerserkEnded.Volume", 5),
  ...
  UNARMED_DENSE_IMPACT_ACTIVATED_VOLUME("Sounds.Unarmed.DenseImpactActivated.Volume", 5),
  ...
  UNARMED_DENSE_IMPACT_ENDED_VOLUME("Sounds.Unarmed.DenseImpactEnded.Volume", 5),
  ...
  SWORDS_RAGE_SPIKE_VOLUME("Sounds.Swords.RageSpike.Volume", 5),
  ...
  SWORDS_TAINTED_BLADE_ENDED_VOLUME("Sounds.Swords.TaintedBladeEnd.Volume", 5),
  ...
  SWORDS_SERRATED_STRIKES_ENDED_VOLUME("Sounds.Swords.SerratedStrikesEnded.Volume", 5),
  ...
  WOODCUTTING_DEMETERS_SHRINE_VOLUME("Sounds.Woodcutting.DemetersShrine.Volume", 5),
  ...
  HERBALISM_NATURES_WRATH_VOLUME("Sounds.Herbalism.NaturesWrath.Volume", 5),
  ...
  EXCAVATION_PANS_SHRINE_VOLUME("Sounds.Excavation.PansShrine.Volume", 5),
  ...
  EXCAVATION_FRENZY_DIG_VOLUME("Sounds.Excavation.FrenzyDig.Volume", 5),
  ...
  BREWING_FINISH_BREW_SOUND_VOLUME("Sounds.Brewing.FinishBrewSound.Volume", 5),
  ...
  BREWING_CIRCES_SHRINE_VOLUME("Sounds.Brewing.CircesShrine.Volume", 5),
  ...
  ARCHERY_BLESSING_OF_ARTEMIS_VOLUME("Sounds.Archery.BlessingOfArtemis.Volume", 5),
  ARCHERY_BLESSING_OF_ARTEMIS_PITCH("Sounds.Archery.BlessingOfArtemis.Pitch", 1),
  ARCHERY_BLESSING_OF_APOLLO_SOUND("Sounds.Archery.BlessingOfApollo.Sound", "ENTITY_BLAZE_SHOOT"),
  ARCHERY_BLESSING_OF_APOLLO_VOLUME("Sounds.Archery.BlessingOfApollo.Volume", 5),
  ARCHERY_BLESSING_OF_APOLLO_PITCH("Sounds.Archery.BlessingOfApollo.Pitch", 1),
  ARCHERY_CURSE_OF_HADES_SOUND("Sounds.Archery.CurseOfHades.Sound", "ENTITY_WITHER_SHOOT"),
  ARCHERY_CURSE_OF_HADES_VOLUME("Sounds.Archery.CurseOfHades.Volume", 5),
  ARCHERY_CURSE_OF_HADES_PITCH("Sounds.Archery.CurseOfHades.Pitch", 1),
  ;
