...
public enum LangEnum implements ConfigurationEnum {
  ...
  MCHELP_MCADMIN4("Messages.Commands.McHelp.McAdmin4", Arrays.asList("&e--------------------------",
          "&7[&6Redeemable Exp Give&7]&3 /mcadmin give exp {Player} {Amount}",
          "&3    -Give a player redeemable exp.",
          "&7[&6Redeemable Level Give&7]&3 /mcadmin give level {Player} {Amount}",
          "&3    -Give a player redeemable levels",
          "&e--------------------------")),
  MCHELP_MCREDEEM("Messages.Commands.McHelp.McRedeem", Arrays.asList("&e--------------------------",
          "&7[&6McRedeem Command&7]&3 /mcredeem {Skill}",
          "&3    -Opens a redeem gui for that skill.",
          "&e--------------------------")),
  ...
  MCADMIN_RECEIVE_REDEEMABLE_EXP("Messages.Commands.Admin.Receive.RedeemableExp", "&aYou were given %Amount% redeemable exp."),
  MCADMIN_RECEIVE_REDEEMABLE_LEVELS("Messages.Commands.Admin.Receive.RedeemableLevels", "&aYou were given %Amount% redeemable levels"),
  ...
  CUSTOM_REDEEM_NOT_ENOUGH_EXP("Messages.CustomRedeem.NotEnoughExp", "&cYou do not have enough redeemable exp to do that."),
  CUSTOM_REDEEM_REDEEMED_EXP("Messages.CustomRedeem.RedeemedExp", "&aYou redeemed %Amount% exp into %Skill%."),
  CUSTOM_REDEEM_NOT_ENOUGH_LEVELS("Messages.CustomRedeem.NotEnoughLevels", "&cYou do not have enough redeemable levels to do that."),
  CUSTOM_REDEEM_REDEEMED_LEVELS("Messages.CustomRedeem.RedeemedLevels", "&aYou redeemed %Amount% levels into %Skill%."),
  ...
  TIPS_LEVEL_UP_SWORDS("Messages.Tips.LevelUpSwords", Arrays.asList("&7[&5McRPG Tip&7]: &aBleed causes repeated damage for a short bit!",
  ...
  TIPS_LEVEL_UP_MINING("Messages.Tips.LevelUpMining", Arrays.asList("&7[&5McRPG Tip&7]: &aDouble Drop and Its A Triple do not stack!",
