...
public enum LangEnum implements ConfigurationEnum {
  ...
  CUSTOM_REDEEM_REDEEMED_EXP("Messages.CustomRedeem.RedeemedExp", "&You redeemed %Amount% exp into %Skill%."),
  ...
  CUSTOM_REDEEM_REDEEMED_LEVELS("Messages.CustomRedeem.RedeemedLevels", "&You redeemed %Amount% levels into %Skill%."),
