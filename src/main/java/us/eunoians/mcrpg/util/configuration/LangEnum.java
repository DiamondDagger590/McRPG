...
public enum LangEnum implements ConfigurationEnum {
    ...
    PARTY_RECEIVED_TPA_REQUEST("Messages.Commands.Parties.ReceivedTpaRequest", "&eYou have been requested to have %Player% teleport t oyou. Do /mcparty tpaccept to accept."),
