...
//    MCADMIN_COPY_INVALID_UUIDS("Messages.Commands.Admin.Copy.InvalidUUIDs", "&cThe UUIDs provided are invalid."),
//    MCADMIN_COPY_DUPLICATE_UUIDS("Messages.Commands.Admin.Copy.DuplicateUUIDs", "&cYou must provide two unique UUIDs."),
//    MCADMIN_COPY_PLAYERS_ARE_ONLINE("Messages.Commands.Admin.Copy.PlayersAreOnline", "&cYou can only use this command whenever both players are offline."),
//    MCADMIN_COPY_DATA_COPIED("Messages.Commands.Admin.Copy.DataCopied", "&aPlayer data has successfully been copied from the two UUIDs."),
