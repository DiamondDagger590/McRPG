...
public enum LangEnum implements ConfigurationEnum {
    ...
    PARTY_CHAT_ENABLED("Messages.Commands.Parties.PartyChatEnabled", "&cOnly owners can edit roles."),
    PARTY_CHAT_DISABLED("Messages.Commands.Parties.PartyChatDisabled", "&cOnly owners can edit roles."),
