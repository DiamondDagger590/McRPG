 ...
 */
public class AbilityUpgradeFilter implements McRPGPlayerContextFilter<Ability> {
        ...
        collection = collection.stream()
                ...
                .filter(tierableAbility -> {
                    ...
                    if (dataOptional.isPresent()) {
                        var upgradableData = dataOptional.get().getAbilityAttribute(AbilityAttributeRegistry.ABILITY_TIER_ATTRIBUTE_KEY);
