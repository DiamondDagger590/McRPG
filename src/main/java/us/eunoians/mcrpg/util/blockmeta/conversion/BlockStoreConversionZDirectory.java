...
import us.eunoians.mcrpg.util.blockmeta.HashChunkletManager;
import us.eunoians.mcrpg.util.blockmeta.PrimitiveChunkletStore;
import us.eunoians.mcrpg.util.blockmeta.PrimitiveExChunkletStore;
import us.eunoians.mcrpg.util.blockmeta.chunkmeta.HashChunkManager;
import us.eunoians.mcrpg.util.blockmeta.chunkmeta.PrimitiveChunkStore;
...
public class BlockStoreConversionZDirectory implements Runnable {
  ...
  public void start(org.bukkit.World world, File xDir, File dataDir){
	...
	this.newManager = (HashChunkManager) McRPG.getPlaceStore();
