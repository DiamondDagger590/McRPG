...
public class QuestDefinitionRegistry implements Registry<QuestDefinition> {
    ...
    /**
     * Deregisters a quest definition by its key. This is used to clean up ephemeral
     * definitions (generated by the template engine) after a quest reaches a terminal
     * state. No-op if no definition is registered with the given key.
     *
     * @param key the key of the definition to remove
     * @return {@code true} if a definition was removed, {@code false} if the key was not registered
     */
