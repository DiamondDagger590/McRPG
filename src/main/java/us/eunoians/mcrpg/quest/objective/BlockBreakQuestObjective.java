...
public class BlockBreakQuestObjective extends QuestObjective {
    ...
    public List<Component> getObjectiveInfoText() {
        ...
        AllowMode allowMode = AllowMode.getAllowMode(this);
        switch (allowMode) {
            case ALLOWED -> info.add(miniMessage.deserialize("<gray>Break these blocks to progress this objective</gray>"));
            case BANNED -> info.add(miniMessage.deserialize("<gray>Break any block besides these to progress this objective</gray>"));
