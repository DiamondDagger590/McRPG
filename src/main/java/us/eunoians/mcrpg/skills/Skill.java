...
public abstract class Skill {
     ...
     */
    private Map<GenericAbility, BaseAbility> abilityMap;
    ...
    public Skill(Skills type, Map<GenericAbility, BaseAbility> abilityMap, int currentLevel, int currentExp, McRPGPlayer player) {
        this.type = type;
