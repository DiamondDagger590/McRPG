...
public class WoodcuttingDAO extends SkillDAO{
    ...
    public static CompletableFuture<Boolean> attemptCreateTable(@NotNull Connection connection, @NotNull DatabaseManager databaseManager) {
        ...
        databaseManager.getDatabaseExecutorService().submit(() -> {
            ...
            /*****
             ** Table Description:
             ** Contains player data for the woodcutting skill
             *
             *
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerWoodcuttingData(@NotNull Connection connection, @NotNull UUID uuid) {
    ...
    public static void savePlayerWoodcuttingData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
