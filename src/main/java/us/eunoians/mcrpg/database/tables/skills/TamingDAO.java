...
public class TamingDAO extends SkillDAO {
    ...
    public static CompletableFuture<Boolean> attemptCreateTable(@NotNull Connection connection, @NotNull DatabaseManager databaseManager) {
        ...
        databaseManager.getDatabaseExecutorService().submit(() -> {
            ...
            /*****
             ** Table Description:
             ** Contains player data for the taming skill
             *
             *
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerTamingsData(@NotNull Connection connection, @NotNull UUID uuid) {
    ...
    public static void savePlayerTamingData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
