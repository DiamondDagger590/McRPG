...
public class AxesDAO extends SkillDAO {
    ...
    public static CompletableFuture<Boolean> attemptCreateTable(@NotNull Connection connection, @NotNull DatabaseManager databaseManager) {
        ...
        databaseManager.getDatabaseExecutorService().submit(() -> {
            ...
            /*****
             ** Table Description:
             ** Contains player data for the axes skill
             *
             *
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerAxesData(@NotNull Connection connection, @NotNull UUID uuid) {
    ...
    public static void savePlayerAxesData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
