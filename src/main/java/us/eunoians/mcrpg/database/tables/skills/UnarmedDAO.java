...
public class UnarmedDAO extends SkillDAO {
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerUnarmedData(@NotNull Connection connection, @NotNull UUID uuid) {
    ...
    public static void savePlayerUnarmedData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
