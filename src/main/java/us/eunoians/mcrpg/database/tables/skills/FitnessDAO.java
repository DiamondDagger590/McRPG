 ...
 */
public class FitnessDAO extends SkillDAO {
    ...
    public static CompletableFuture<Boolean> attemptCreateTable(@NotNull Connection connection, @NotNull DatabaseManager databaseManager) {
        ...
        databaseManager.getDatabaseExecutorService().submit(() -> {
            ...
            /*****
             ** Table Description:
             ** Contains player data for the fitness skill
             *
             *
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerFitnessData(@NotNull Connection connection, @NotNull UUID uuid) {
        return getSkillData(TABLE_NAME, connection, uuid, Skills.FITNESS);
    }

    //TODO because I only care about loading player data rn and cba to save it
    public static void savePlayerFitnessData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
