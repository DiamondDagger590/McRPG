...
public class ArcheryDAO extends SkillDAO {
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerArcheryData(@NotNull Connection connection, @NotNull UUID uuid) {
    ...
    public static void savePlayerArcheryData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
