...
public class HerbalismDAO {
     ...
     * and default exp/level values set to 0
     */
    public static CompletableFuture<SkillDataSnapshot> getPlayerHerbalismData(Connection connection, UUID uuid) {

        DatabaseManager databaseManager = McRPG.getInstance().getDatabaseManager();
        Skills skillType = Skills.HERBALISM;
    ...
    public static void savePlayerHerbalismData(Connection connection, McRPGPlayer mcRPGPlayer) {
