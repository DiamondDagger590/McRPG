...
public class TamingTable{
  ...
  @Column(defaultValue = "1") private boolean is_fury_of_cerebus_toggled;
  ...
  @Column(defaultValue = "0") private int fury_of_cerebus_tier;
  
  @Column(defaultValue = "0") private int fury_of_cerebus_cooldown;
  ...
  @Column(defaultValue = "0") private boolean is_fury_of_cerebus_pending;
}
