...
public class ExcavationDAO extends SkillDAO {
    ...
    public static CompletableFuture<Boolean> attemptCreateTable(@NotNull Connection connection, @NotNull DatabaseManager databaseManager) {
        ...
        databaseManager.getDatabaseExecutorService().submit(() -> {
            ...
            /*****
             ** Table Description:
             ** Contains player data for the excavation skill
             *
             *
     ...
     */
    @NotNull
    public static CompletableFuture<SkillDataSnapshot> getPlayerExcavationData(@NotNull Connection connection, @NotNull UUID uuid) {
    ...
    public static void savePlayerExcavationData(@NotNull Connection connection, @NotNull McRPGPlayer mcRPGPlayer) {
