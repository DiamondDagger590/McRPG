...
public final class CombatLogDAO {
     ...
     * <p>
     * Batching stops as soon as a batch comes back short of {@link #DELETE_BATCH_SIZE}, which means
     * the statement ran out of matching rows. Looping until a batch reports zero instead would cost
     * an extra round trip on every sweep, and would never terminate against a statement whose
     * update count does not drain to zero.
     *
     * @param connection The database connection.
