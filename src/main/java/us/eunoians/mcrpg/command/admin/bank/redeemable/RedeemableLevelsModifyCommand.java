...
/**
 * Command used to modify a player's redeemable levels.
 */
    ...
    public static void registerCommand() {
        ...
        commandManager.command(commandManager.commandBuilder("mcrpg")
                ...
                .handler(commandContext -> {
                    ...
                    senderAudience.sendMessage(localizationManager.getLocalizedMessageAsComponent(senderAudience, LocalizationKey.REMOVE_REDEEMABLE_LEVELS_COMMAND_SENDER_ERROR_MESSAGE, senderPlaceholders));
        ...
        commandManager.command(commandManager.commandBuilder("mcrpg")
                ...
                .handler(commandContext -> {
                    ...
                    senderAudience.sendMessage(localizationManager.getLocalizedMessageAsComponent(senderAudience, LocalizationKey.RESET_REDEEMABLE_LEVELS_COMMAND_SENDER_ERROR_MESSAGE, senderPlaceholders));
