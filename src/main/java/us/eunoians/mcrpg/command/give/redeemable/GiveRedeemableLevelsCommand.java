 ...
 */
public class GiveRedeemableLevelsCommand extends GiveRedeemableCommandBase {

    private static final Permission GIVE_REDEEMABLE_LEVELS_PERMISSION = Permission.of("mcrpg.give.redeemable.levels");
    ...
    public static void registerCommand() {
        ...
        commandManager.command(commandManager.commandBuilder("mcrpg")
                ...
                .permission(Permission.anyOf(ROOT_PERMISSION, GIVE_COMMAND_ROOT_PERMISSION, GIVE_REDEEM_COMMAND_ROOT_PERMISSION, GIVE_REDEEMABLE_LEVELS_PERMISSION))
                .handler(commandContext -> {
                    ...
                    Map<String, String> senderPlaceholders = getPlaceholders(senderAudience, senderAudience, player, levelAmount, senderOptional.orElse(null));
                    Map<String, String> receiverPlaceholders = getPlaceholders(player, senderAudience, player, levelAmount, playerOptional.orElse(null));
    ...
    @NotNull
    private static Map<String, String> getPlaceholders(@NotNull Audience messageAudience, @NotNull Audience senderAudience, @NotNull Audience receiverAudience, int levels, @Nullable McRPGPlayer mcRPGPlayer) {
