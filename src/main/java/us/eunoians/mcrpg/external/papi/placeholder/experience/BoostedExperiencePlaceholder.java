 ...
 * about a player's current boosted experience amount.
 */
public class BoostedExperiencePlaceholder extends McRPGPlaceholder {

    private static final String PLACEHOLDER = "boosted_experience";

    public BoostedExperiencePlaceholder() {
        super(PLACEHOLDER);
    }
    ...
    public String parsePlaceholder(@NotNull OfflinePlayer offlinePlayer) {
        ...
        if (playerOptional.isPresent()) {
            ...
            return Integer.toString(experienceExtras.getBoostedExperience());
        }
        return null;    }
}
