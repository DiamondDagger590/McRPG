...
public class EnchantmentMeta {
    ...
    @Getter private ArrayList<FishingItemEnchant> enchants = new ArrayList<>();
    @Getter private boolean overrideExistingEnchants;
    @Getter private int lowEndEnchantAmount;
    @Getter private int highEndEnchantAmount;
