...
import us.eunoians.mcmmox.util.blockmeta.ChunkletStore;
import us.eunoians.mcmmox.util.blockmeta.HashChunkletManager;
import us.eunoians.mcmmox.util.blockmeta.PrimitiveChunkletStore;
import us.eunoians.mcmmox.util.blockmeta.PrimitiveExChunkletStore;
import us.eunoians.mcmmox.util.blockmeta.chunkmeta.HashChunkManager;
import us.eunoians.mcmmox.util.blockmeta.chunkmeta.PrimitiveChunkStore;
...
public class BlockStoreConversionZDirectory implements Runnable {
  ...
  public void start(org.bukkit.World world, File xDir, File dataDir){
	...
	this.newManager = (HashChunkManager) Mcmmox.getPlaceStore();
